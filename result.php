...
if(isset($_POST['keyword'])) {
    ...
    echo $keyword;
    $query = "SELECT p.name, p.description, p.pid FROM Project p, Tag t where p.pid = t.tid and (t.tname = {$keyword} or p.description LIKE '%{$keyword}%' or p.name LIKE '%{$keyword}%')";
